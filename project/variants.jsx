  ...
  return (
    <div style={{ paddingBottom: 90, fontFamily: 'var(--sans)' }}>
      ...
      <div style={{ padding: '6px 16px 0', display: 'flex', alignItems: 'center', gap: 8 }}>
        <img src="assets/logo-epona.png" style={{ width: 22, height: 22 }} alt="" />
  ...
  return (
    <div style={{ paddingBottom: 90, fontFamily: 'var(--sans)' }}>
      <div style={{ padding: '20px 24px 0', display: 'flex', alignItems: 'center' }}>
        <img src="assets/logo-epona.png" style={{ width: 34, height: 34 }} alt="" />
        <div style={{ flex: 1 }} />
...
Object.assign(window, { HomeScreenB, HomeScreenC });
